...
./mvnw package
```
It produces the `docs-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/docs-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/docs-1.0.0-SNAPSHOT-runner`
